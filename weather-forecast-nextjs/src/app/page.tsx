    ...
    <div className=' ml-4 mr-4'>
        ...
        <div>
            <div className=' flex justify-between'>
                ...
                <div>
                   <Link href={'/search'}> <Button variant='ghost'>Search By City Name</Button></Link>
                </div>
            ...
            <Table>
                ...
                <TableBody>
                    {data.map((item, index) => (
                        <TableRow key={index}>
                            <TableCell>
                                <Link onClick={() => addToHistory(item.ascii_name, item.coordinates.lat, item.coordinates.lon)} href={
                                  {
                                    pathname :"/city" ,
                                    query : {
